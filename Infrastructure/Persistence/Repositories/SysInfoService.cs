...
namespace Infrastructure.Persistence.Repositories
{
  public class SysInfoService : ISysInfoService
  {
    ...
    // ✅ Update
    public async Task<bool> UpdateAsync(SysInfo dto)
    {
      _context.SysInfos.Update(dto);
    ...
    // ✅ Get By Id
    public async Task<SysInfo?> GetByIdAsync(int id)
    {
      var entity = await _context.SysInfos
          .AsNoTracking()
          .FirstOrDefaultAsync(x => x.Id == id);
      ...
      return _mapper.Map<SysInfo>(entity);
    }
